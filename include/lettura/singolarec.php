 ...
 <body>
    ...
    <div class="content">
        <?php
            ...
            $sqllettura = "SELECT * FROM recensioni WHERE rec_id='$id'"; //Seleziono l'articolo con id uguale a quello che l'utente ha cliccato
            ...
            if (mysqli_num_rows($risultatiagg) > 0) {                  //Se c'è almeno una riga
                while($row = mysqli_fetch_assoc($risultatiagg)) {           //Fornisce i dati e li associa ai nomi delle colonne del database
                    ...
                    <p class="recarticolo" align='justify' style="padding-right: 15px;"> <!-- Immagine e articolo a fianco -->
                        <img class="image" src="../../images/imgpost/<?=$imgrec;?>" align="left" hspace="10"> 
